...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
  ...
  src: {
    ...
    desktop: [
      ...
      "assets/images/DesktopWallpaper/d11.jpeg",
      "assets/images/DesktopWallpaper/d12.avif",
    ],
    // 移动背景图片（支持单张或多张随机）
    // mobile: "assets/images/MobileWallpaper/m1.avif",
    mobile: [
      "assets/images/MobileWallpaper/m7.jpeg"
    ],
    // 背景视频播放地址
  ...
  common: {
    ...
    homeText: {
      ...
      subtitle: [
        "烟花易逝，人情长存。",
        "没事做的话，我来给你讲故事吧！",
        "每一朵烟花的绽放，都是我心中的愿望飞向天空。",
        "生活嘛，就是要随心所欲地活着！就像我手中的烟花，想怎么放就怎么放！",
        "哎呀，别这么愁眉苦脸的嘛！人生就像放烟花，总有那么几个瞬间是值得庆祝的！",
        "嘿，你知道吗？烟花最美的不是它爆炸的那一刻，而是我们共同期待它升起的心情。",
        "烟花易冷，人事易分，但我对你的心意永不褪色。",
      ],
      // 主页横幅副标题字体大小
      subtitleSize: "1.5rem",
      typewriter: {
